// Inline-SVG icon set (stroke-based, 24x24) — zero-dependency replacement for
// the emoji/unicode glyphs the app used to use. Each entry is the *inner*
// markup of an <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">.
// Rendered by Icon.svelte.
...
export const ICON_PATHS: Record<IconName, string> = {
  ...
  map: '<path d="m9 3 6 3 5.447-2.724A1 1 0 0 1 21 4.618v11.764a1 1 0 0 1-.553.894L15 20l-6-3-5.447 2.724A1 1 0 0 1 3 18.882V7.118a1 1 0 0 1 .553-.894z"/><path d="M9 3v15"/><path d="M15 6v15"/>',
  workflow:
